		...
		<tbody>
			...
			<tr class="<?php echo $noembed_cls;?>cvwp-no-embed-hide">
				...
				<td class="cvwp-player-aspect-options">
					...
					?>
					<label for="cvwp-width"><?php _e('Width', 'videographywp');?>:</label> <input class="cvwp_video_width" size="2" type="text" id="cvwp-width" name="cvwp_post[video][width]" value="<?php echo $width;?>"<?php echo $disabled;?> /> px |
			...
			<tr class="<?php echo $noembed_cls;?>cvwp-no-embed-hide">
				...
				<td>
					...
					<?php else:?>
						<input type="text" value="<?php echo $options['video']['volume'];?>" name="cvwp_post[video][volume]" id="cvwp-volume" size="2" />

		...
		<div id="cvwp-tabs" class="cvwp-tabs" data-storage_var="cvwp_settings_tab">
			...
			<div id="cvwp-settings" class="cvwp-panel hide-if-js">
				...
				<table class="form-table">
					<tbody>
						<tr>
							<th><label for=""><?php _e( 'Allow for post type', 'videographywp' );?>:</label></th>
							<td>
								<span class="description"><?php _e('In Lite version, only regular posts are enabled for featured video embedding.', 'videographywp');?></span>
							</td>
						</tr>
						<tr>
				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="apis_youtube_key" id="apis-youtube-key" value="<?php echo esc_attr( $apis['youtube_key'] );?>" autocomplete="off" size="60" /></td>
						</tr>
					</tbody>
				</table>
				<?php submit_button( __('Save settings', 'videographywp') );?>

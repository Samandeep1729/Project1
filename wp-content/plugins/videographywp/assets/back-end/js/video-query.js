...
;(function($){
	...
	var embedPosition = function(){
		$('#cvwp-embed-position').change(function(){
	...
	var removeVideo = function(){
		...
		$('#cvwp-remove-video').click(function(e){
			e.preventDefault;
	...
	var videoQuery = function(){
		...
		var parent 		= $('#cvwp-video-query'),
			submitBtn 	= $('#cvwp-video-query-btn'),
			id			= $(parent).find('input[name=cvwp_video_id]'),
			messages	= cvwp_query.messages,
	...
	var aspectRatio = function(){
		...
		$(document).on( 'keyup', '.cvwp_video_width', function(){
	...
	var cvwp_clear_editor = function( edId ) {
		var editor,
